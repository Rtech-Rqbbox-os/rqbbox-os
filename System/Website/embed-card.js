(function() {
  ...
  var BASE = 'https://rtech-rqbbox-os.github.io/rqbbox-os';
  ...
  function createWidget(target) {
    ...
    w.innerHTML = [
      ...
      '</div>',
      '<div class="rqbbox-ew-badges"><span class="rqbbox-ew-badge">v1.2.0</span><span class="rqbbox-ew-badge">Open Source</span><span class="rqbbox-ew-badge">Free</span><span class="rqbbox-ew-badge">PS5 UI</span></div>',
      '<div class="rqbbox-ew-desc">A portable USB-based gaming OS that runs entirely from a USB drive without installation. PS5-inspired UI, pro audio engine, 43+ store packages, phone bootloader. Works on Windows, macOS, Linux, Android, iOS, and KaiOS.</div>',
      ...
      '  <div class="rqbbox-ew-f"><strong>👤 Multi-User</strong> &bull; Auth, friends, cloud sync</div>',
      '</div>',
      ...
      '  <a class="rqbbox-ew-btn rqbbox-ew-btn-ghost" href="' + BASE + '/website/os-info-card.html" target="_blank"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 014 10 15.3 15.3 0 01-4 10 15.3 15.3 0 01-4-10 15.3 15.3 0 014-10z"/></svg> Info</a>',
      '</div>',
