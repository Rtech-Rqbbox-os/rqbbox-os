...
client.on('interactionCreate', async interaction => {
  ...
  if (interaction.commandName === 'rqbbox') {
    const embed = new EmbedBuilder()
      ...
      .setDescription('A portable USB-based gaming OS by RhysTech. PS5-inspired UI, pro audio engine, 43+ store packages, phone bootloader. Runs from a USB drive without installation.')
      .setColor(0x00D4FF)
      .setThumbnail('https://rtech-rqbbox-os.github.io/rqbbox-os/System/Branding/rqbbox-logo.svg')
      .addFields(
        { name: '🎮 Features', value: '6 Games · 43+ Packages · PS5 UI · Pro Audio · Phone Boot · Multi-User', inline: false },
